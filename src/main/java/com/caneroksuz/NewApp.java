...
//        System.out.println(userController.findByUsername("musty"));
...
//        userRepository.findAllFirstname().forEach(x-> System.out.println(x));
//        userRepository.findAllFirstNameStartWith("M").forEach(x-> System.out.println(x));
//        userRepository.findAllFirstNameStartWithAndGtPostCount("M",6).forEach(x-> System.out.println(x));
...
//        System.out.println(userRepository.avgPostCount());
    /*    List<Object[]> array = userRepository.groupByPostCount();
        ...
        // 2. olarak bu şekilde de yazdırabiliriz..
        for (Object[] objectArray: array) {
...
//        System.out.println(userRepository.mostPostingUser2());

/*        List<Object[]> array =userRepository.getUsernameGenderPostCount();
        for (Object[] objectArray: array) {
            System.out.println(Arrays.toString(objectArray));
        }*/

/*        List<Object[]> array =userRepository.getUserGendersWithTotalPost();
        for (Object[] objectArray: array) {
            System.out.println(Arrays.toString(objectArray));
        }*/


        System.out.println(postRepository.findByUserPostId(4L));
